...
import me.psikuvit.betterbalance.commands.arg.EarnArg;
import me.psikuvit.betterbalance.commands.arg.GiveArg;
import me.psikuvit.betterbalance.commands.arg.SetBalanceArg;
import me.psikuvit.betterbalance.commands.arg.ViewBalanceArg;
...
public class CommandRegister implements CommandExecutor, TabCompleter {
    ...
    public CommandRegister(final BetterBalance plugin) {
        commandAbstractMap = new HashMap<>();
        commandAbstractMap.put("balance", new ViewBalanceArg(plugin));
        commandAbstractMap.put("earn", new EarnArg(plugin));
        commandAbstractMap.put("give", new GiveArg(plugin));
        commandAbstractMap.put("set", new SetBalanceArg(plugin));
    }
